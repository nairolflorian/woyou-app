const de: Record<string, string> = {
  ...
  "tips.h": "So machst du dein Profil noch stärker",
  "tips.delta": "+{delta}%",
  "tips.firstName": "Vorname eintragen",
  "tips.lastName": "Nachname eintragen",
  "tips.dateOfBirth": "Geburtsdatum angeben",
  "tips.nationality": "Staatsangehörigkeit angeben",
  "tips.countryOfResidence": "Aktuelles Wohnland angeben",
  "tips.city": "Stadt angeben",
  "tips.desiredJobCategory": "Wunsch-Berufsgruppe wählen",
  "tips.germanLevel": "Deutschniveau angeben",
  "tips.yearsExperience": "Berufserfahrung in Jahren angeben",
  "tips.earliestStart": "Frühestmöglichen Starttermin wählen",
  "tips.aboutMe": "Kurze Selbstbeschreibung schreiben",
  "tips.motivation": "Motivation für Deutschland erklären",
  "chat.read_status": "✓ gelesen {time}",
  "chat.unread": "Ungelesen",
  "edit.email": "Neue E-Mail",
  "edit.phone": "Neue Telefonnummer",
  "edit.current_password": "Aktuelles Passwort",
  "edit.new_password": "Neues Passwort (min. 6 Zeichen)",
  "edit.save": "Änderungen speichern",
  "edit.saving": "Speichere…",
  "edit.saved": "Gespeichert ✓",
  "edit.h_login": "Login-Daten ändern",
  "edit.hint":
    "Du kannst E-Mail und Telefon ändern. Passwort-Wechsel erfordert das aktuelle Passwort.",
  "edit.err_wrong_password": "Aktuelles Passwort ist falsch.",
  "edit.err_taken": "Diese E-Mail oder Telefonnummer ist bereits vergeben.",
  "edit.err_no_password": "Für diesen Account ist kein Passwort gesetzt — bitte über den Telegram-Login.",
